...
const About = () => {
    return (
        <motion.div id='about' className='flex flex-col mx-auto max-w-4xl mt-10 w-full px-5'
        ...
        >
            <div className="flex flex-col items-center">
                <p
                    className='text-sm ovo dark:text-slate-300'>Introduction</p>
                    ...
                    <div className="grid md:grid-cols-3 gap-3 mt-3">
                        {
                            aboutData.map((data, index) => (
                                <div key={index} className="hover:scale-105 duration-300 flex flex-col gap-1 hover:-translate-y-1 border border-slate-200 dark:border-slate-700 hover:dark:border-slate-400 hover:dark:bg-zinc-900 hover:border-slate-300 hover:bg-teal-50 rounded-lg p-3 hover:shadow-[3px_3px_0_rgba(0,0,0,0.8)] transition-all">
