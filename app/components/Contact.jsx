    ...
    return (
        <motion.div
            ...
            <div className="flex flex-col items-center">
                ...
                <p transition={{ duration: 0.6, delay: 0.6 }}
                    className='text-sm ovo dark:text-slate-300'>Connect with me</p>

                <h1 transition={{ duration: 0.6, delay: 0.6 }}
                    className='text-3xl font1'>Get in touch</h1>
            ...
            <form onSubmit={onSubmit} className="flex flex-col gap-5 mt-5">
                ...
                <button disabled={sending} className="disabled:cursor-not-allowed disabled:opacity-50 dark:bg-teal-800 hover:dark:bg-teal-900 flex items-center px-5 py-3 justify-center rounded-full text-sm gap-2 text-slate-100 hover:text-slate-100 transition-all cursor-pointer hover:bg-black bg-black/90 hover:shadow-[1px_1px_20px_rgba(0,0,0,0.4)] hover:scale-95 active:scale-85">
                    {
